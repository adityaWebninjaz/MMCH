...
import {
  getCompensatoryOffReport,
  exportCompensatoryOffReportPDF,
  exportCompensatoryOffReportExcel
} from '@/views/SuperMostAdmin/HRMS/Reports/Services/compensatoryOffReportService';
...
const CompensatoryOffReport = () => {
  ...
  const formattedDisplayDate = useMemo(() => {
    if (!selectedExpiryDate) return '01 Aug 2026';
    const d = new Date(selectedExpiryDate);
  ...
  const fetchReportData = async () => {
    setLoading(true);
    const res = await getCompensatoryOffReport({
  ...
  const handleExportExcel = () => {
    ...
    const headers = ['Emp ID', 'Emp Name', 'Department', 'Credit Earned', 'Utilized', 'Expired', 'Current Balance', 'Next Expiry Date'];
    ...
    link.download = `Compensatory_Off_Report_${new Date().toISOString().slice(0, 10)}.csv`;
    ...
    <Box sx={{ width: '100%', bgcolor: '#ffffff', minHeight: '100vh', p: { xs: 2, sm: 3, md: 4 } }}>
      ...
      >
        ...
        >
          ...
          <FormControl size="small" sx={{ minWidth: { xs: '100%', sm: 200 }, flex: { xs: '1 1 100%', sm: 'none' }, position: 'relative' }}>
            <Typography variant="caption" sx={{ color: '#1E293B', fontWeight: 400, mb: '6px', fontSize: '13px', lineHeight: '100%' }}>
              Expiry Date
            </Typography>
            <Button
      ...
      <Grid container spacing="12px" sx={{ mb: '24px' }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          >
            <Typography variant="h3" sx={{ fontWeight: 700, color: '#0F172A', fontSize: '24px', lineHeight: '100%', mb: '8px' }}>
              {stats.activeBalanceCompOff}
            </Typography>
            <Typography variant="body2" sx={{ fontSize: '13px', fontWeight: 600, color: '#475569', lineHeight: '100%' }}>
              Active balance Compensatory Off
            </Typography>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          >
            <Typography variant="h3" sx={{ fontWeight: 700, color: '#0F172A', fontSize: '24px', lineHeight: '100%', mb: '8px' }}>
              {stats.empWithCompOff}
            </Typography>
            <Typography variant="body2" sx={{ fontSize: '13px', fontWeight: 600, color: '#475569', lineHeight: '100%' }}>
              Employee with Compensatory Off
            </Typography>
          </Card>
        </Grid>
      </Grid>
        ...
        >
          <TableHead>
            <TableRow sx={{ bgcolor: '#F1F5F9' }}>
              ...
              <TableCell align="center" sx={{ color: '#16151C', fontWeight: 600, fontSize: '14px', py: 1.5, px: '24px', lineHeight: '20px' }}>Credit Earned</TableCell>
              <TableCell align="center" sx={{ color: '#16151C', fontWeight: 600, fontSize: '14px', py: 1.5, px: '24px', lineHeight: '20px' }}>Utilized</TableCell>
              <TableCell align="center" sx={{ color: '#16151C', fontWeight: 600, fontSize: '14px', py: 1.5, px: '24px', lineHeight: '20px' }}>Expired</TableCell>
              <TableCell align="center" sx={{ color: '#16151C', fontWeight: 600, fontSize: '14px', py: 1.5, px: '24px', lineHeight: '20px' }}>Current Balance</TableCell>
              <TableCell align="center" sx={{ color: '#16151C', fontWeight: 600, fontSize: '14px', py: 1.5, px: '24px', lineHeight: '20px' }}>Next Expiry Date</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {loading ? (
              ...
              <TableRow>
                <TableCell colSpan={8} align="center" sx={{ py: 6, color: '#64748B', borderBottom: 'none' }}>
