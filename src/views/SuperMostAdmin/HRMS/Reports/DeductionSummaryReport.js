...
import {
  getDeductionSummaryReport,
  exportDeductionSummaryReportPDF,
  exportDeductionSummaryReportExcel
} from 'views/SuperMostAdmin/HRMS/Reports/Services/deductionSummaryReportService';
...
const DeductionSummaryReport = () => {
  ...
  const fetchReportData = async () => {
    setLoading(true);
    const res = await getDeductionSummaryReport({
  ...
  const handleExportExcel = () => {
    ...
    const headers = ['Emp ID', 'Emp Name', 'Department', 'Room Rent', 'Electricity', 'Bus Pass', 'Front Office', 'Miscellaneous', 'Total Deduction'];
    ...
    link.download = `Deduction_Summary_Report_${new Date().toISOString().slice(0, 10)}.csv`;
        ...
        >
          <TableHead>
            <TableRow sx={{ bgcolor: '#F1F5F9' }}>
              ...
              <TableCell align="center" sx={{ color: '#16151C', fontWeight: 600, fontSize: '14px', py: 1.5, px: '24px', lineHeight: '20px' }}>Room Rent</TableCell>
              <TableCell align="center" sx={{ color: '#16151C', fontWeight: 600, fontSize: '14px', py: 1.5, px: '24px', lineHeight: '20px' }}>Electricity</TableCell>
              <TableCell align="center" sx={{ color: '#16151C', fontWeight: 600, fontSize: '14px', py: 1.5, px: '24px', lineHeight: '20px' }}>Bus Pass</TableCell>
              <TableCell align="center" sx={{ color: '#16151C', fontWeight: 600, fontSize: '14px', py: 1.5, px: '24px', lineHeight: '20px' }}>Front Office</TableCell>
              <TableCell align="center" sx={{ color: '#16151C', fontWeight: 600, fontSize: '14px', py: 1.5, px: '24px', lineHeight: '20px' }}>Miscellaneous</TableCell>
            ...
            {loading ? (
              ...
              <TableRow>
                <TableCell colSpan={9} align="center" sx={{ py: 6, color: '#64748B', borderBottom: 'none' }}>
                  No deduction summary records found
                </TableCell>
              </TableRow>
            ) : (
...
export default DeductionSummaryReport;
