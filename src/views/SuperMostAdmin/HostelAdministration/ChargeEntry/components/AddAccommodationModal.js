  ...
  const handleConfirm = () => {
    ...
    if (onConfirm) {
      onConfirm({
        ...
        notes: notes.trim() || 'Accommodation charge',
      ...
      <DialogContent sx={{ p: 0, overflow: 'visible', display: 'flex', flexDirection: 'column', flex: 1 }}>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: '22px', flex: 1 }}>
          ...
          <Box>
            ...
            >
              Search for a resident/employee to assign accommodation charges.
            </Typography>
          </Box>
            ...
            <>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                <TextField
                  ...
                  placeholder="e.g. Accommodation charge"
                  disabled={loading}
                  sx={{
                    bgcolor: '#ffffff',
                    borderRadius: '8px',
              ...
              >
                ...
                >
                  {loading ? <CircularProgress size={20} sx={{ color: '#FFFFFF' }} /> : 'Add Accommodation'}
                </Button>
              </Box>
            </>
          )}
